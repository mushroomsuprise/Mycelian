 ...
 */
type Manifest_7_0 = Omit<Manifest, "Software"> & {
    /**
 ...
 * Defines the plugin and available actions, and all information associated with them, including the plugin's entry point, all iconography, action default behavior, etc.
 */
type Manifest$1 = JsonSchema<Manifest_6_4> | JsonSchema<Manifest_6_5> | JsonSchema<Manifest_6_6> | JsonSchema<Manifest_6_9> | JsonSchema<Manifest_7_0>;
